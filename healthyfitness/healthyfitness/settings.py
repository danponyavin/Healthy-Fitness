"""
Django settings for healthyfitness project.
...
SECRET_KEY = 'django-insecure-ltffys44-(_89wuj8g!pifhvhv%=1cj#i)znxxfy1eui(#c++)'
...
ROOT_URLCONF = 'healthyfitness.urls'
...
WSGI_APPLICATION = 'healthyfitness.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, "media")  # директория с картинками пользователей
MEDIA_URL = '/media/'
